...
import styles from "./NexoraCaseStudy.module.scss";
import HeroImg from "./Hero.jpg";
// Sec 2
import Sec2Full from "./Sec2Full.jpg";
import Sec2Img1 from "./Sec2Img1.png";
import Sec2Img2 from "./Sec2Img2.png";
// import Sec2Img3 from "./Sec2Img3.jpg";
// Sec 3
import Sec3Full from "./Sec3Full.png";
import Sec3Img1 from "./Sec3Img1.png";
import Sec3Img2 from "./Sec3Img2.png";
...
import sec4Full from "./Sec4Full.png";
...
export default function HMS() {
  ...
  const sec2Images = [Sec2Img1, Sec2Img2];
  const sec3UpImages = [Sec3Img1, Sec3Img2, Sec3Img3];
    ...
    >
      ...
      >
        ...
        <div className={styles.rightSide}>
          <div className={styles.textContent}>
            <p>
              Nexora Labs is not just a biotech company — it’s a hub of
              cutting-edge research, molecular innovation, and future-facing
              discoveries. With a fast-evolving product portfolio and a strong
              focus on R&D, they needed a brand identity that could match the
              intellectual precision and quiet confidence of their work. They
              partnered with Haraay Design Studio to develop a visual language
              that would feel contemporary, credible, and deeply rooted in
              science.
            </p>
          </div>
        </div>
      ...
      >
        ...
        <div className={styles.rightSide}>
          <div className={styles.textContent}>
            <p>
              Our design direction was built on one key idea: <br />
              Science is beautiful when made visible.
              <br /> We wanted Nexora’s brand to capture the quiet
              sophistication of molecular research, while remaining approachable
          ...
          <div className={styles.textContent}>
            <div className={styles.challengeItem}>
              <p className={styles.challengeTitle}>
                {/* Packaging Design: */}
                <span>
                  <b> Visual Identity:</b> A squishy, punchy logotype that looks
                  like it could be chewed. Bold, edible color palette — Lemon ,
                  Blue Raspberry , Orange , Cherry . Playful typography with
                  wobbly energy. Kid-drawn-style icons and wild doodles
                  <br />
                  <br />
                  <b>Packaging Design: </b> Tubes designed to pop on the shelf
                  and bathroom counter. Custom flavor illustrations and
                  character motifs. Fun unboxing moments with surprise graphics
                  inside
                </span>
              </p>
            </div>
