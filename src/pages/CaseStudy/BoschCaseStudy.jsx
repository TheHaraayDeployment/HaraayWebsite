...
import akoyahero from "../../assets/Bosch/hero.jpg";
import akoyaoverview from "../../assets/Bosch/sec2.png";
    ...
    <div className={styles.akoyacasecontainer}>
      ...
      <div className={styles.akoyacasesection}>
        <div className={styles.akoyacasetext}>
          <h2>Background</h2> <div className={styles.rightbox}>
          <p>
          Bosche, a brand dedicated to clean and healthy living, wanted to showcase its air purifier with a compelling visual narrative. Haraay Design stepped in to create high-quality 3D animation and imagery, highlighting the purifier’s sleek design, advanced filtration technology, and efficiency in action.
          </p>
        </div>
        </div>
        <div className={styles.akoyacasetext}>
          ...
          <p>
        <ul><li>Effectively demonstrating the air purification process visually</li> <li>Showcasing the product’s premium aesthetics and functionality.</li> <li>Creating engaging content for marketing and digital platforms.</li></ul>
          </p>
        </div>
        </div>
      ...
      <div className={`${styles.akoyacasesection}, ${styles.akoyacasebranding}`}>
        <div className={styles.akoyacasetext}>
          ...
          <p>
          High-Quality 3D Animation – Showcased the air purifier’s filtration process, airflow dynamics, and real-life impact in an engaging format.Photorealistic 3D Renders – Created stunning visuals to highlight the product’s design and features.Immersive Storytelling – Ensured the animations weren’t just technical but also emotionally resonant, connecting with health-conscious consumers.
          </p>
        </div>
        </div>
        <img src={akoyabranding} alt="Branding" className={styles.akoyascaseimages} />
      </div>
   ...
   */}
      ...
      <div className={`${styles.akoyacasesection} ${styles.akoyacasepackaging}`}> 
        <div className={styles.akoyacasetext}>
          ...
          <p>
          Enhanced Product Understanding : Customers could visually grasp the benefits and technology behind Bosche Air Purifier.Increased Engagement : The 3D video became a powerful asset for digital marketing and promotions.Premium Brand Perception : The stunning visuals positioned Bosche as an innovative and high-quality brand in the air purification industry.
          Through cutting-edge 3D animation and imagery, we didn’t just showcase a product—we brought it to life. This is the power of visual storytelling.
          </p>
        </div>
        </div>
        <img src={akoyapackaging} alt="Packaging" className={`${styles.akoyascaseimages} ,${styles.topview}`} />
      </div>
