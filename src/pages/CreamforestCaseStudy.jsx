...
import bakershero from "../assets/creamforestcase_heroimg.svg";
import bakersoverview from "../assets/creamforest__casestudy_overview.svg";
import bakersbranding from "../assets/creamforest_casestudy_branding.svg";
import bakerscolorpallet from "../assets/bakers_casestudy_colorpallet.svg";
import bakerspackaging from "../assets/creamforest_casestudy_packaging.svg";
      ...
      <div className="bakerscase-container">
        ...
        <section className="bakerscase-section bakerscase-overview">
          ...
          <div className="bakerscase-text">
            <h2>Overview</h2>
            <p>
              s is the only one stop bakery point which provides heavenly
        ...
        <section className="bakerscase-section bakerscase-branding">
          <div className="bakerscase-text">
            <h2>Branding</h2>
            <p>
              Cream Forest is a high-end brand. Since their menu is inspired by
              various heritage locations throughout the world, we were tasked
              with producing branding and packaging designs for the same.
            </p>
          </div>
          <img
            src={bakersbranding}
