...
import heroImage from "../assets/bakers_casestudy_hero.jpg";
          ...
          <div className="responsive-section__left">
            <div className="bakerdetail-client-brief-text">
              ...
              <p>
                ...
                by various heritage locations throughout the world, we were
                tasked with producing branding and packaging designs for the
                same. For the entire brand, we took a friendly, clean, and
                minimal approach, coupled with some customized typefaces that
                would relate to the bite mark, which resembles a cookie bite,
                and the bits and pieces of crumbs that would tie to the whole
                brand's aesthetics and audience.
              </p>
            </div>
          </div>{" "}
          <div className="responsive-section__right imgscroll-section">
          ...
          <div className="responsive-section__left">
            <div className="bakerdetail-client-brief-text">
              ...
              <p>
                ...
                is distinctive because these colors are not very commonly used.
